...
public class AppConfig {
	...
	Order orderTest() {
		...
		orderItem.add(pizzaMargheritaBean());
		orderItem.add(pizzaSalamiBean());
		orderItem.add(pizzaHawaiianBean());
		orderItem.add(lemonadeBean());
		orderItem.add(waterBean());
		getTable1(@Value("${seat.price}") double seatPrice);
	}
}
